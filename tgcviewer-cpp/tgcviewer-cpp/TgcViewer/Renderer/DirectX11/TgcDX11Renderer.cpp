...
TgcWindowHandler* TgcDX11Renderer::createWindowHandler()
{
	return new Win32WindowHandler();
}

bool TgcDX11Renderer::init(GuiControllerConfig config)
{
	this->vsync = config.vsync;
	this->screenFarDistance = config.screenFarDistance;
	this->screenNearDistance = config.screenNearDistance;
	...
	int screenWidth = windowHandler->screenWidth;
	int screenHeight = windowHandler->screenHeight;
    ...
    swapChainDesc.OutputWindow = windowHandler->hwnd;
